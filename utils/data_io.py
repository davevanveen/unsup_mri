...
def get_path_loss_curve(file_id, NUM_ITER, DC_STEP, ALPHA):
    ...
    fn_mse_wrt_ksp = '{}mse_wrt_ksp_{}'.format(path_out, suffix)
    fn_mse_wrt_img = '{}mse_wrt_img_{}'.format(path_out, suffix)

    return fn_mse_wrt_ksp, fn_mse_wrt_img

def save_output(img_dc, mse_wrt_ksp, mse_wrt_img, \
    ...
    fn_mse_wrt_ksp, fn_mse_wrt_img = get_path_loss_curve(\
                                file_id, NUM_ITER, DC_STEP, ALPHA)
    np.save(fn_mse_wrt_ksp, mse_wrt_ksp)
    np.save(fn_mse_wrt_img, mse_wrt_img)
